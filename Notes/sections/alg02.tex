...
\end{itemize}
%
%Two cases ... $Q_1$ may not be square ...  
%
%
...
\Red{Question: what's are the cases of CSD used in GSVD?} 
...
\subsection{CSD in LAPACK 3.9.0} 
\begin{enumerate} 
...
\Red{Q: is there the CSD for an orthnormal matrix? i.e.,
the matrix is ``tall'' with orthonormal columns} 
