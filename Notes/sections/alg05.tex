...
\paragraph{Step 3. Safe Diagonalization of $Q_1$ and $Q_2$:} \footnote{It happens to be a special case of the 2-by-1 Cosine-sine decomposition}
...
%$T^{T}T = (UR)^{T}UR = R^{T}U^{T}UR = R^{T}R$ in exact arithmetics. Since $R$ is upper triangular, $R$ has to be diagonal. Then,  \eqref{eq-q_1-case1} above can be treated as the SVD of $Q_1$. 
